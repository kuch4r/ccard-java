...
public class RegisterSet {
    ...
    public final static int LOG2_BITS_PER_WORD = 4;
    public final static int REGISTER_SIZE = 8;
    ...
    public void set(int position, int value) {
        ...
        this.M[bucketPos] = (this.M[bucketPos] & ~(0xff << shift)) | (value << shift);
    }
    ...
    public int get(int position) {
        ...
        return (this.M[bucketPos] & (0xff << shift)) >>> shift;
    }
